...
terraform {
  backend "azurerm" {
    resource_group_name  = "resource_main"
    storage_account_name = "deepamcourseyh" # Provide Storage Account name, where Terraform Remote state is stored
...
provider "azurerm" {
  features {}
  subscription_id = "316ab800-22b5-40ab-be41-8595de4fb2d4"
}
